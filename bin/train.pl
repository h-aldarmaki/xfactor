...
### 1. preprocess text
my $cmd;
$cmd = "perl  $home_dir/bin/Preprocess/clean.pl  $model_dir/train.txt  $model_dir/train.clean";
print "[step 1]: $cmd\n\n";
`$cmd`;
...
### 3. apply ormf 
$cmd = "nice matlab -r \"path(path,'$home_dir/ormf'); train_ormf('$model_dir/train.ind', '$model_dir/model', $k, $lambda, $wm, $alpha, $n_itrs); exit\"";
print "[step 3]: $cmd\n\n";
print `$cmd`;
